...
quibble.reset = function (hard) {
  ...
  const communication = quibbleUserToLoaderCommunication

  communication && communication.reset()
...
quibble.listMockedModules = function () {
  const communication = quibbleUserToLoaderCommunication()
  const esmMockedModules = defaultValue(communication && communication.listMockedModules(), [])
